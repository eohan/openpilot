...
/**
 * Input object: Mission (following XXX mission language)
 * Input object: PositionActual
 * Input object: ManualControlCommand
 * Output object: ActiveWaypoint
 *
 * This module will periodically update the value of the XXX position input object.
 *
...
{
	// Start main task
	xTaskCreate(guidanceTask, (signed char *)"Mission", STACK_SIZE_BYTES/4, NULL, TASK_PRIORITY, &guidanceTaskHandle);
...
MODULE_INITCALL(MissionInitialize, MissionStart)
...
static void guidanceTask(void *parameters)
{
	...
	MissionSettingsData guidanceSettings;
	...
	while (1) {
		MissionSettingsGet(&guidanceSettings);
