						       ...
						       uint8_t target_system, uint8_t target_component, float roll, float pitch, float yaw, float thrust)
{
	...
	put_float_by_index(roll, 0,  msg->payload); // Desired roll angle in radians
	put_float_by_index(pitch, 4,  msg->payload); // Desired pitch angle in radians
	put_float_by_index(yaw, 8,  msg->payload); // Desired yaw angle in radians
	...
	return mavlink_finalize_message(msg, system_id, component_id, 18, 252);
}
						           ...
						           uint8_t target_system,uint8_t target_component,float roll,float pitch,float yaw,float thrust)
{
	...
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 18, 252);
}
						           ...
						           uint8_t target_system,uint8_t target_component,float roll,float pitch,float yaw,float thrust)
{
	...
	mavlink_finalize_message_chan_send(msg, chan, 18, 252);
}
