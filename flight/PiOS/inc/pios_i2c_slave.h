...
typedef void (* pios_i2c_slave_callback)(uint32_t i2c_id, pios_i2c_slave_event event, uint32_t arg);
...
extern void PIOS_I2C_SLAVE_Transfer(uint32_t i2c_id, pios_i2c_slave_txn txn_list[], uint32_t num_txns);
